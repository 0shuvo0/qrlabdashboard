...
const removeNFCBtns = $$('.generated-link-item .badge-btn.edit .popup-btn-link:nth-child(3)')
...
const removeNFCModal = $('.remove-nfc-modal-wrapper')
...
removeNFCBtns.forEach(btn => {
    btn.addEventListener('click', () => {
        removeNFCModal.classList.remove('hidden')
    })
})
